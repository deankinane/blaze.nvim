...
theme.set_highlights = function()
  ...
  hl(0, "Pmenu", { fg = c.light_gray, bg = c.bg_dark, sp = 'NONE', blend=50,  })
  hl(0, "PmenuSel", { fg = c.yellow, bg = c.bg_dark })
  hl(0, "WildMenu", { fg = c.fg, bg = c.ui2_blue })
  hl(0, "CursorLineNr", { fg = c.light_gray, bg = 'NONE', bold=true, })
  hl(0, "Comment", { fg = c.comment, bg = c.black })
  hl(0, "Folded", { fg = c.accent, bg = c.bg_dark })
  hl(0, "FoldColumn", { fg = c.accent, bg = c.bg_dark })
  hl(0, "LineNr", { fg = c.comment, bg = 'NONE' })
  hl(0, "FloatBorder", { fg = c.gray, bg = c.bg_dark })
  ...
  hl(0, "DiffAdd", { fg = c.bg_dark, bg = c.sign_add })
  hl(0, "DiffChange", { fg = c.bg_dark, bg = c.sign_change, underline=true, })
  hl(0, "DiffDelete", { fg = c.bg_dark, bg = c.sign_delete })
  ...
  hl(0, "Type", { fg = c.pink_vivid, bg = 'NONE' })
  hl(0, "StorageClass", { fg = c.blue, bg = 'NONE' })
  hl(0, "Structure", { fg = c.pink_vivid, bg = 'NONE' })
  ...
  hl(0, "TSConditional", { fg = c.white, bg = 'NONE' })
  hl(0, "TSException", { fg = c.white, bg = 'NONE' })
  hl(0, "TSInclude", { fg = c.white, bg = 'NONE' })
  hl(0, "TSKeywordReturn", { fg = c.white, bg = 'NONE' })
  hl(0, "TSKeyword", { fg = c.white, bg = 'NONE' })
  hl(0, "TSKeywordFunction", { fg = c.white, bg = 'NONE' })
  hl(0, "TSLabel", { fg = c.light_blue, bg = 'NONE' })
  hl(0, "TSNamespace", { fg = c.cyan, bg = 'NONE' })
  hl(0, "TSRepeat", { fg = c.white, bg = 'NONE' })
  ...
  hl(0, "TSKeywordOperator", { fg = c.white, bg = 'NONE' })
  ...
  -- typescript
  hl(0, "typescriptBraces", { fg = c.white, bg = 'NONE' })
  hl(0, "typescriptParens", { fg = c.white, bg = 'NONE' })
  hl(0, "typescriptDestructureVariable", { fg = c.yellow, bg = 'NONE' })
  hl(0, "typescriptVariableDeclaration", { fg = c.yellow, bg = 'NONE' })
  hl(0, "typescriptFuncCallArg", { fg = c.white, bg = 'NONE' })
  hl(0, "typescriptBlock", { fg = c.pink, bg = 'NONE' })
  hl(0, "typescriptAssign", { fg = c.fg, bg = 'NONE' })
  ...
  hl(0, "typescriptArrowFunc", { fg = c.fg, bg = 'NONE' })
  hl(0, "typescriptArrowFuncDef", { fg = c.fg, bg = 'NONE' })
  hl(0, "typescriptFuncTypeArrow", { fg = c.fg, bg = 'NONE' })
  hl(0, "typescriptObjectLiteral", { fg = c.fg, bg = 'NONE' })
  hl(0, "typescriptObjectColon", { fg = c.fg, bg = 'NONE' })
  hl(0, "typescriptCall", { fg = c.yellow, bg = 'NONE' })
  hl(0, "typescriptIdentifierName", { fg = c.yellow, bg = 'NONE' })
  hl(0, "typescriptTypeReference", { fg = c.red, bg = 'NONE' })
  hl(0, "typescriptProp", { fg = c.white, bg = 'NONE' })
  hl(0, "typescriptParenExp", { fg = c.red, bg = 'NONE' })
  hl(0, "typescriptFuncType", { fg = c.yellow, bg = 'NONE' })

  -- tsx
  hl(0, "htmlTag", { fg = c.fg, bg = 'NONE' })
  hl(0, "htmlTagName", { fg = c.fg, bg = 'NONE' })
  hl(0, "tsxTag", { fg = c.fg, bg = 'NONE' })
  hl(0, "tsxTagName", { fg = c.red, bg = 'NONE' })
  hl(0, "tsxAttrib", { fg = c.fg_vivid, bg = 'NONE' })
  hl(0, "tsxEqual", { fg = c.fg, bg = 'NONE' })
  hl(0, "tsxEscjs", { fg = c.yellow, bg = 'NONE' })
  ...
  -- Whichkey
  hl(0, "WhichKey", { fg = c.white, bg = 'NONE' })
  ...
  hl(0, "LspDiagnosticsDefaultInformation", { fg = c.info_white, bg = 'NONE' })
  hl(0, "LspDiagnosticsDefaultInfo", { fg = c.info_white, bg = 'NONE' })
  ...
  hl(0, "LspDiagnosticsVirtualTextInformation", { fg = c.info_white, bg = 'NONE' })
  hl(0, "LspDiagnosticsVirtualTextInfo", { fg = c.info_white, bg = 'NONE' })
  ...
  hl(0, "LspDiagnosticsFloatingInformation", { fg = c.info_white, bg = 'NONE' })
  hl(0, "LspDiagnosticsFloatingInfo", { fg = c.info_white, bg = 'NONE' })
  ...
  hl(0, "DiagnosticSignInformation", { fg = c.info_white, bg = 'NONE' })
  hl(0, "DiagnosticSignInfo", { fg = c.info_white, bg = 'NONE' })
  ...
  hl(0, "LspDiagnosticsSignInformation", { fg = c.info_white, bg = 'NONE' })
  hl(0, "LspDiagnosticsSignInfo", { fg = c.info_white, bg = 'NONE' })
  ...
  hl(0, "LspDiagnosticsInformation", { fg = c.info_white, bg = 'NONE' })
  hl(0, "LspDiagnosticsInfo", { fg = c.info_white, bg = 'NONE' })
  ...
  -- Telescope
  hl(0, "TelescopeSelection", { fg = c.yellow, bg = 'NONE' })
  hl(0, "TelescopeMatching", { fg = c.info_white, bg = 'NONE', bold=true, })
  ...
  hl(0, "BufferCurrentMod", { fg = c.info_white, bg = c.bg })
  ...
  hl(0, "BufferVisibleMod", { fg = c.info_white, bg = c.bg })
  hl(0, "BufferVisibleSign", { fg = c.gray, bg = c.bg })
  hl(0, "BufferVisibleTarget", { fg = c.red, bg = c.bg, bold=true, })
  hl(0, "BufferInactive", { fg = c.gray, bg = c.bg_dark })
  hl(0, "BufferInactiveIndex", { fg = c.gray, bg = c.bg_dark })
  hl(0, "BufferInactiveMod", { fg = c.info_white, bg = c.bg_dark })
  hl(0, "BufferInactiveSign", { fg = c.gray, bg = c.bg_dark })
  ...
  hl(0, "CmpItemKindKeyword", { fg = c.white, bg = 'NONE' })
  ...
  hl(0, "netrwDir", { fg = c.pink, bg = 'NONE' })
  hl(0, "netrwClassify", { fg = c.pink, bg = 'NONE' })
